...
// Misc
#define CHAOS_EFFECT_FORWARD_CAMERA 13      // Sets camera type to forward
#define CHAOS_EFFECT_EXPLOSIONS 14          // Spawns explosion particles around Samus

// One time effects
#define CHAOS_EFFECT_ONE_TIME 15            // Marks the start of one time effects

#define CHAOS_EFFECT_SPAWN_ENEMY 15         // Spawns an enemy in the spriteset near Samus
#define CHAOS_EFFECT_SPAWN_PB 16            // Spawns a power bomb near Samus
#define CHAOS_EFFECT_FREEZE_ENEMIES 17      // Freezes all freezable enemies in the room
#define CHAOS_EFFECT_SCREEN_SHAKE 18        // Sets the screen shake timer
#define CHAOS_EFFECT_KNOCKBACK_SAMUS 19     // Put Samus in knockback pose
#define CHAOS_EFFECT_SHINE_TIMER 20         // Set the shinespark timer
#define CHAOS_EFFECT_CHANGE_ENERGY_AMMO 21  // Sets energy or ammo to a random amount
#define CHAOS_EFFECT_PAUSE_GAME 22          // Pauses the game
#define CHAOS_EFFECT_RAND_SOUND 23          // Plays a random sound, like lightning or Ridley
#define CHAOS_EFFECT_COLOR_EFFECT 24        // Changes the background colors (brightness, monochrome)
