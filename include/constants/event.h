...
MAKE_ENUM(u8, Event) {
    ...
    // In rando, this indicates if Ruins Test is defeated, not if you have
...
#ifdef RANDOMIZER
    EVENT_LOCATION_LONG_BEAM,
    EVENT_LOCATION_ICE_BEAM,
    EVENT_LOCATION_WAVE_BEAM,
    EVENT_LOCATION_BOMBS,
    EVENT_LOCATION_MORPH_BALL,
    EVENT_LOCATION_SPEED_BOOSTER,

    EVENT_ZIPLINES_SOURCE,
