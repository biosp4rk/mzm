...
static const u16 sSpacePirateCarryingPowerBombOam_Frame0[OAM_DATA_SIZE(15)] = {
    ...
    0xd6, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd3, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c0,
#else // !RANDOMIZER
...
static const u16 sSpacePirateCarryingPowerBombOam_Frame1[OAM_DATA_SIZE(15)] = {
    ...
    0xd5, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd3, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c2,
#else // !RANDOMIZER
...
static const u16 sSpacePirateCarryingPowerBombOam_Frame2[OAM_DATA_SIZE(15)] = {
    ...
    0xd4, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd2, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c4,
#else // !RANDOMIZER
...
static const u16 sSpacePirateCarryingPowerBombOam_Frame3[OAM_DATA_SIZE(15)] = {
    ...
    0xd5, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd2, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c6,
#else // !RANDOMIZER
...
static const u16 sSpacePirateCarryingPowerBombOam_Frame4[OAM_DATA_SIZE(15)] = {
    ...
    0xd6, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd4, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c0,
#else // !RANDOMIZER
...
static const u16 sSpacePirateCarryingPowerBombOam_Frame7[OAM_DATA_SIZE(15)] = {
    ...
    0xd5, OBJ_SIZE_16x16 | 0x1f8, OBJ_SPRITE_OAM | 0x240,
#ifdef RANDOMIZER
    0xd3, OBJ_X_FLIP | OBJ_SIZE_16x16 | 0x1e1, OBJ_SPRITE_OAM | 0x32c6,
#else // !RANDOMIZER
