...
IWRAM_DATA u8 gMonochromeBgFading = 0;
...
IWRAM_DATA u8 gCurrentHazeValue = 0;
...
IWRAM_DATA u8 gCurrentClipdataAffectingAction = 0;
...
IWRAM_DATA u8 gUpdateMinimapFlag = 0;
